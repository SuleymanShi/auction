    ...
    <div class="card-body">
      ...
      <form method="post" action="create_auction_result.php">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <textarea class="form-control" name="auctionDetails" id="auctionDetails" placeholder="blah blah blah" rows="4"></textarea>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <select class="form-control" name="auctionCategory" id="auctionCategory">
              <option name='1' selected>Choose...</option>
              <option name='2' value="fill">Fill me in</option>
              <option name='3' value="with">with options</option>
              <option name='4' value="populated">populated from a database?</option>
            </select>
